...
a3 = ArbreBinaire()
a3.ajouter_depuis_tableau([3, 2, 4, 1, None, None, None, None])
a4 = ArbreBinaire()
a4.ajouter_depuis_tableau([3, 2, 4, None, 1, None, None, None])
a5 = ArbreBinaire()
a5.ajouter_depuis_tableau([3, 2, 6, 0, 4, None, None])
a6 = ArbreBinaire()
